...
struct LeafNode {
    // Used to store segments in the leaf node of the tree
...
public:
    ...
    // Search for the segment corresponding to the key
    ...
    // Get the number of segments in the tree
    size_t get_segment_count() const {
        size_t count = tree_index_.size();
        return count;
    };

    // Get the size of segment in total in bytes
