...
void checkForEpsilon(size_t n, Fin data, std::vector<SegmentType> segments,int begin = 0,int ed = 1, double epsilon = 0.1){
    ...
    while (data(i) <= end && i < n)
    {
        ...
        // printf("The predict index is %Lf the real index is %d\n",slope*data(i)+intercept,i);
        i++;
    }
}
}
